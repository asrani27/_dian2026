                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <div class="mb-8">
                            <svg class="w-32 h-32 mx-auto" viewBox="0 0 200 200" fill="none" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <path d="M100 60 L100 100 M100 120 L100 140" 
                                      stroke="white" stroke-width="4" stroke-linecap="round"/>
                                <circle cx="100" cy="100" r="25" stroke="white" stroke-width="3" fill="none"/>
                            </svg>
                        </div>
                        
                        <h1 class="text-4xl font-bold mb-4">Sesi Berakhir</h1>
                        <h2 class="text-2xl font-light mb-6 opacity-90">Waktu sesi Anda telah habis</h2>
                        <p class="text-lg opacity-80 max-w-md mx-auto leading-relaxed">
                            Untuk keamanan akun Anda, sesi login telah berakhir. 
                ...
                <div class="lg:w-1/2 p-8 lg:p-12">
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="text-center mb-8">
                            ...
                            <h2 class="text-3xl font-bold text-gray-900">Login Kembali</h2>
                            <p class="mt-2 text-gray-600">Sesi Anda telah berakhir, silakan login untuk melanjutkan</p>
                        </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    ...
                                    <p class="mt-1 text-sm text-orange-700">
                                        Untuk keamanan, silakan login kembali dengan akun Anda.
                                    </p>
                                </div>
                            </div>
                        </div>
