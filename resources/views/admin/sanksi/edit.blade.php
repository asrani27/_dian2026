...
<div class="p-6">
    ...
    <div class="flex items-center mb-6">
        ...
        <div>
            <h1 class="text-3xl font-bold text-gray-900">Edit Sanksi</h1>
            <p class="text-gray-600 mt-1">Perbarui data sanksi: {{ $sanksi->nama_sanksi }}</p>
        </div>
    </div>
    ...
    <div class="bg-white rounded-xl shadow-sm border border-gray-200">
        <div class="px-6 py-4 border-b border-gray-200 bg-gray-50">
            <h2 class="text-lg font-semibold text-gray-900">Form Edit Sanksi</h2>
        </div>
        
        <form action="{{ route('admin.sanksi.update', $sanksi) }}" method="POST" class="p-6">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           value="{{ old('penanggung_jawab', $sanksi->penanggung_jawab) }}"
                           class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="keterangan" 
                              ...
                              placeholder="Tambahkan keterangan atau deskripsi sanksi...">{{ old('keterangan', $sanksi->keterangan) }}</textarea>
                    @error('keterangan')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
                ...
                <div class="flex">
                    ...
                    <div class="ml-3">
                        <p class="text-sm text-blue-700">
                            Data sanksi ini dibuat pada {{ $sanksi->created_at->format('d M Y H:i') }} 
                            dan terakhir diperbarui pada {{ $sanksi->updated_at->format('d M Y H:i') }}
                        </p>
                    </div>
                </div>
            </div>
