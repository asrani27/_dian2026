...
@section('page-description', 'Tambah data alat laboratorium baru')
...
<div class="mx-auto">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="text-gray-500 ml-1 md:ml-2">Tambah Alat</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <h2 class="text-xl font-semibold text-gray-900">Form Tambah Alat</h2>
            <p class="text-gray-600 mt-1">Isi data alat laboratorium yang akan ditambahkan</p>
        </div>

        <form action="{{ route('admin.alat.store') }}" method="POST" class="p-6">
            @csrf
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <select id="jenis" name="jenis"
                        ...
                        <option value="mekanik" {{ old('jenis')=='mekanik' ? 'selected' : '' }}>Mekanik</option>
                        <option value="kimia" {{ old('jenis')=='kimia' ? 'selected' : '' }}>Kimia</option>
                        <option value="fisika" {{ old('jenis')=='fisika' ? 'selected' : '' }}>Fisika</option>
                        <option value="biologi" {{ old('jenis')=='biologi' ? 'selected' : '' }}>Biologi</option>
                ...
                <div>
                    ...
                    <input type="text" id="bahan" name="bahan" value="{{ old('bahan') }}"
                ...
                <div class="md:col-span-2">
                    ...
                    <textarea id="keterangan" name="keterangan" rows="4"
                        ...
                        placeholder="Tambahkan keterangan atau catatan tentang alat ini...">{{ old('keterangan') }}</textarea>
                    @error('keterangan')
                    <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
