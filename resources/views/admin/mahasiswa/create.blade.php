...
@section('page-description', 'Tambah data mahasiswa baru')
...
<div class="mx-auto">
        ...
        <ol class="inline-flex items-center space-x-1 md:space-x-3">
            ...
            <li aria-current="page">
                <div class="flex items-center">
                    ...
                    <span class="text-gray-500 ml-1 md:ml-2">Tambah Mahasiswa</span>
                </div>
            </li>
        </ol>
    </nav>
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200">
        <div class="p-6 border-b border-gray-200">
            <div>
                <h2 class="text-xl font-semibold text-gray-900">Tambah Data Mahasiswa</h2>
                <p class="text-gray-600 mt-1">Isi form di bawah ini untuk menambahkan data mahasiswa baru</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    <div class="relative">
                        ...
                        <input type="tel" name="telp" id="telp" value="{{ old('telp') }}" required
                            class="pl-10 w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-blue-500"
