    ...
    <div class="min-h-screen flex items-center justify-center px-4 py-12 sm:px-6 lg:px-8">
        <div class="w-full max-w-6xl bg-white rounded-2xl shadow-2xl overflow-hidden">
            <div class="flex flex-col lg:flex-row">
                ...
                <div
                    class="lg:w-1/2 bg-gradient-to-br from-blue-600 to-emerald-600 p-8 lg:p-12 flex flex-col justify-center items-center text-white relative overflow-hidden">
                    <!-- Background Pattern -->
                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <div class="mb-8">
                            <svg class="w-32 h-32 mx-auto" viewBox="0 0 200 200" fill="none"
                                ...
                                <circle cx="100" cy="100" r="80" stroke="white" stroke-width="3"
                                    fill="rgba(255,255,255,0.1)" />
                                <path d="M70 80 L70 120 M130 80 L130 120 M85 65 L115 65 M85 135 L115 135" stroke="white"
                                    stroke-width="4" stroke-linecap="round" />
                                <circle cx="100" cy="100" r="25" stroke="white" stroke-width="3" fill="none" />
                                <path d="M90 90 L110 110 M110 90 L90 110" stroke="white" stroke-width="3"
                ...
                <div class="lg:w-1/2 p-8 lg:p-12">
                    <div class="max-w-md mx-auto">
                        ...
                        <div class="text-center mb-8">
                            <div
                                class="inline-flex items-center justify-center w-16 h-16 bg-gradient-to-br from-blue-600 to-emerald-600 rounded-2xl mb-4">
                            ...
                            <div>
                                ...
                                <div class="relative">
                                    ...
                                    <button type="button" id="togglePassword"
                                        ...
                                        <svg id="eyeOffIcon"
                                            class="h-5 w-5 text-gray-400 hover:text-gray-600 transition-colors hidden"
                                            fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
